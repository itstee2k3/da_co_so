...
namespace do_an_ltweb.Admin.AdCategory.AdCategoryOrigin
{
    ...
    public class CreateModel : PageModel
    {
        ...
        {
            [Display(Name = "Name of CategoryBrand")]
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (_context.CategoryOrigins.Any(c => c.NameCategory == Input.Name))
            {
            ...
            // Tạo mới danh mục
            var newCategory = new CategoryOrigin
            {
                NameCategory = Input.Name,
                Hide = 0 // Gán giá trị Hide thành 0
            };
            _context.CategoryOrigins.Add(newCategory);
            await _context.SaveChangesAsync();

            TempData["StatusMessage"] = $"You have just created a new origin category: {Input.Name}";
