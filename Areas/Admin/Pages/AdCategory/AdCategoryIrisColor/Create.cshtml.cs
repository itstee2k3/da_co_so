...
namespace do_an_ltweb.Admin.AdCategory.AdCategoryIrisColor
{
    ...
    public class CreateModel : PageModel
    {
        ...
        {
            [Display(Name = "Name of CategoryIrisColor")]
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (_context.CategoryIrisColors.Any(c => c.NameCategory == Input.Name))
            {
            ...
            // Tạo mới danh mục
            var newCategory = new CategoryIrisColor
            {
                NameCategory = Input.Name,
                Hide = 0 // Gán giá trị Hide thành 0
            };
            _context.CategoryIrisColors.Add(newCategory);
            await _context.SaveChangesAsync();

            TempData["StatusMessage"] = $"You have just created a new iris color category: {Input.Name}";
