...
namespace do_an_ltweb.Admin.AdCategory.AdCategoryFrameColor
{
    ...
    public class CreateModel : PageModel
    {
        ...
        {
            [Display(Name = "Name of CategoryFrameColor")]
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (_context.CategoryFrameColors.Any(c => c.NameCategory == Input.Name))
            {
            ...
            // Tạo mới danh mục
            var newCategory = new CategoryFrameColor
            {
                NameCategory = Input.Name,
                Hide = 0 // Gán giá trị Hide thành 0
            };
            _context.CategoryFrameColors.Add(newCategory);
            await _context.SaveChangesAsync();

            TempData["StatusMessage"] = $"You have just created a new frame color category: {Input.Name}";
