...
namespace do_an_ltweb.Admin.AdCategory.AdCategorySex
{
    ...
    public class CreateModel : PageModel
    {
        ...
        {
            [Display(Name = "Name of CategorySex")]
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (_context.CategorySexes.Any(c => c.NameCategory == Input.Name))
            {
            ...
            // Tạo mới danh mục
            var newCategory = new CategorySex
            {
                NameCategory = Input.Name,
                Hide = 0 // Gán giá trị Hide thành 0
            };
            _context.CategorySexes.Add(newCategory);
            await _context.SaveChangesAsync();

            TempData["StatusMessage"] = $"You have just created a new sex category: {Input.Name}";
