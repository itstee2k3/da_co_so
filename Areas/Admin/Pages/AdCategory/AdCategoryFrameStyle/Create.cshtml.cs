...
namespace do_an_ltweb.Admin.AdCategory.AdCategoryFrameStyle
{
    ...
    public class CreateModel : PageModel
    {
        ...
        {
            [Display(Name = "Name of CategoryFramColor")]
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (_context.CategoryFrameStyles.Any(c => c.NameCategory == Input.Name))
            {
            ...
            // Tạo mới danh mục
            var newCategory = new CategoryFrameStyle
            {
                NameCategory = Input.Name,
                Hide = 0 // Gán giá trị Hide thành 0
            };
            _context.CategoryFrameStyles.Add(newCategory);
            await _context.SaveChangesAsync();

            TempData["StatusMessage"] = $"You have just created a new frame style category: {Input.Name}";
