...
namespace do_an_ltweb.Admin.AdCategory.AdCategoryBrand
{
    ...
    public class CreateModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (_context.CategoryBrands.Any(c => c.NameCategory == Input.Name))
            {
            ...
            // Tạo mới danh mục
            var newCategory = new CategoryBrand
            {
                NameCategory = Input.Name,
                Hide = 0 // Gán giá trị Hide thành 0
            };
            _context.CategoryBrands.Add(newCategory);
            await _context.SaveChangesAsync();

            TempData["StatusMessage"] = $"You have just created a new brand category: {Input.Name}";
